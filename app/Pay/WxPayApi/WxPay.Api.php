<?php
namespace App\Pay\WxPayApi;


use App\Pay\WxPayApi\WxPayData\WxPayBizPayUrl;
use App\Pay\WxPayApi\WxPayData\WxPayCloseOrder;
use App\Pay\WxPayApi\WxPayData\WxPayDownloadBill;
use App\Pay\WxPayApi\WxPayData\WxPayMicroPay;
use App\Pay\WxPayApi\WxPayData\WxPayNotifyResults;
use App\Pay\WxPayApi\WxPayData\WxPayOrderQuery;
use App\Pay\WxPayApi\WxPayData\WxPayRefund;
use App\Pay\WxPayApi\WxPayData\WxPayRefundQuery;
use App\Pay\WxPayApi\WxPayData\WxPayReport;
use App\Pay\WxPayApi\WxPayData\WxPayResults;
use App\Pay\WxPayApi\WxPayData\WxPayReverse;
use App\Pay\WxPayApi\WxPayData\WxPayShortUrl;
use App\Pay\WxPayApi\WxPayData\WxPayUnifiedOrder;
...
class WxPayApi
{
	 ...
	 *
	 * @param WxPayConfigInterface $config WxPayConfigInterface 配置对象
	 * @param WxPayUnifiedOrder $inputObj WxPayUnifiedOrder
	 * @param int $timeOut
	 ...
	 * appid、mchid、spbill_create_ip、nonce_str不需要填入
	 *
	 * @param WxPayConfigInterface $config  WxPayConfigInterface配置对象
	 * @param WxPayOrderQuery $inputObj WxPayOrderQuery
	 * @param int $timeOut
	 * @throws WxPayException
	 * @return 成功时返回，其他抛异常
	 */
	 ...
	 *
	 * @param WxPayConfigInterface $config  WxPayConfigInterface配置对象
	 * @param WxPayCloseOrder $inputObj	WxPayCloseOrder
	 * @param int $timeOut
	 * @throws WxPayException
	 * @return 成功时返回，其他抛异常
	 */
	 ...
	 *
	 * @param WxPayConfigInterface $config  WxPayConfigInterface配置对象
	 * @param WxPayRefund $inputObj	WxPayRefund
	 * @param int $timeOut
	 * @throws WxPayException
	 * @return 成功时返回，其他抛异常
	 */
	 ...
	 *
	 * @param WxPayConfigInterface $config  WxPayConfigInterface配置对象
	 * @param WxPayRefundQuery $inputObj	WxPayRefundQuery
	 * @param int $timeOut
	 * @throws WxPayException
	 * @return 成功时返回，其他抛异常
	 */
	 ...
	 *
	 * @param WxPayConfigInterface $config  WxPayConfigInterface配置对象
	 * @param WxPayDownloadBill $inputObj	WxPayDownloadBill
	 * @param int $timeOut
	 * @throws WxPayException
	 * @return 成功时返回，其他抛异常
	 */
	 ...
	 *
	 * @param WxPayConfigInterface $config  WxPayConfigInterface配置对象
	 * @param WxPayMicroPay $inputObj		WxPayMicroPay
	 * @param int $timeOut
	 */
	 ...
	 *
	 * @param WxPayConfigInterface $config  WxPayConfigInterface配置对象
	 * @param WxPayReverse $inputObj	WxPayReverse
	 * @param int $timeOut
	 * @throws WxPayException
	 */
	 ...
	 *
	 * @param WxPayConfigInterface $config  WxPayConfigInterface配置对象
	 * @param WxPayReport $inputObj	 WxPayReport
	 * @param int $timeOut
	 * @throws WxPayException
	 * @return 成功时返回，其他抛异常
	 */
	 ...
	 *
	 * @param WxPayConfigInterface $config  WxPayConfigInterface配置对象
	 * @param WxPayBizPayUrl $inputObj	WxPayBizPayUrl
	 * @param int $timeOut
	 * @throws WxPayException
	 ...
	 *
	 * @param WxPayConfigInterface $config  WxPayConfigInterface配置对象
	 * @param WxPayShortUrl $inputObj	WxPayShortUrl
	 * @param int $timeOut
	 * @throws WxPayException
	 * @return 成功时返回，其他抛异常
	 */
	public static function shorturl($config, $inputObj, $timeOut = 6)
	{
 	 ...
 	 *
 	 * @param callback $callback		 原型为：function function_name($data){}
 	 */
