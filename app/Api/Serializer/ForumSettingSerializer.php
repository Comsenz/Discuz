    ...
    public function getDefaultAttributes($model)
    {
        $attributes = [
            ...
            'paycenter' => [
                ...
                'wxpay_app_key' => $this->settings->get('wxpay_app_key', 'wxpay'),
                'wxpay_app_secret' => $this->settings->get('wxpay_app_secret', 'wxpay'),
            ],

            // 附件设置
            'setattach' => [
                'support_img_ext' => $this->settings->get('support_img_ext'),
                'support_file_ext' => $this->settings->get('support_file_ext'),
                'support_max_size' => (int)$this->settings->get('support_max_size', 'default', ini_get('upload_max_filesize')),
            ],
