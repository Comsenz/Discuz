...
class QeuryTrade
{
	 ...
	 * @return mixed              支付信息
	 */
	public static function query($query_type, $trade_no, $config, $extra = array())
	{
		$result = [];//返回参数
		switch ($query_type) {
	...
	public static function wechatQuery($query_type, $trade_no, $config, $extra = array())
	{
		...
		$response = $gateway->query([
		    'transaction_id' => $trade_no, //The wechat trade no
		])->send();
