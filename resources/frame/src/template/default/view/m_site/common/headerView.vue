      ...
      <div class="invitePerDet aaa" v-show="invitePerDet">
        ...
        <!-- <img src="../../../../../../static/images/noavatar.gif" class="inviteHead"> -->
          ...
          <div class="followBox" v-if="followShow">
            ...
            <a href="javascript:;" class="alreadFollow" v-if="userId != personUserId && intiFollowVal == '0'" @click="followCli(intiFollowVal)">关注TA</a>
            <a href="javascript:;" class="alreadFollow" v-else-if="userId != personUserId && intiFollowVal == '2'" @click="followCli(intiFollowVal)">相互关注</a>
            <a href="javascript:;" class="followHe" v-else="userId != personUserId && intiFollowVal == '1'" @click="followCli(intiFollowVal)">已关注</a>
          </div>
      </div>
