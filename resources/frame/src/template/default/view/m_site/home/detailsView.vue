    ...
    <van-pull-refresh v-model="isLoading" @refresh="onRefresh">
      <div class="content marBfixed" v-if="themeShow">
        <div class="cirPostCon">
          <div class="postTop">
            <div class="postPer">
              <img
                ...
                alt
                class="postHead"
                v-if="themeCon.user && themeCon.user._data.avatarUrl == '' && themeCon.user._data.avatarUrl == null"
              />
          ...
          <div class="uploadFileList">
            ...
            >
              ...
              <span
                v-else-if="attachment._data.extension === 'word'"
                class="icon iconfont icon-word"
              ></span>
              ...
              <span
                v-else-if="attachment._data.extension === 'TIFF'"
                class="icon iconfont icon-TIFF"
              ></span>
          ...
          <div class="postDetBot">
            ...
            <div
              class="screen"
              @click="bindScreen"
              v-if="themeCon._data.canEssence || themeCon._data.canSticky || themeCon._data.canDelete || themeCon._data.canEdit"
            >
              <span>管理</span>
        ...
        <div class="detailsFooter">
          ...
          <div
            class="footChi"
            @click="replyOpera(themeCon.firstPost._data.id,'2',themeCon.firstPost._data.isLiked)"
          >
        ...
        >
          ...
          <div class="rewardMonBox">
            <div
              ...
              :key="i"
              @click="rewardPay(rewardChi.rewardNum)"
            >
      ...
      <van-image-preview v-model="imageShow" :images="firstpostImageList" @change="onChange">
