import Vue from 'vue';
import {Pagination,Upload,Popover,DatePicker,FormItem,Form,Option,Select,TableColumn,Table,CheckboxGroup,Checkbox,RadioButton,RadioGroup,Radio,Card,Button,Message,Input,Container,Header,Aside,Main,Menu,MenuItem,Loading } from 'element-ui'
