...
CREATE TABLE `pre_circles` (
    ...
    `property` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '属性：公开、私密',
...
CREATE TABLE `pre_circle_extends` (
    ...
    `price` decimal(10,2) NOT NULL DEFAULT '0.00' COMMENT '圈子图标',
    `share_rule` varchar(200) NOT NULL DEFAULT '' COMMENT '分成规则',
